...
const index = () => {
  return (
    <div className="w-full h-screen relative">
      ...
      <div className="text-center leading-loose absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <h3 className="text-2xl text-gray-900">Towards a better future</h3>
